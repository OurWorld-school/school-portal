...
const AdminViewResult = () => {
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(UpdateResultPositionApi + userId, data, headers)
        ...
        <Table responsive striped bordered>
          ...
          >
            <tr>
              ...
              <th>Head Teacher Reamrk</th>
              <th className="text-center">
                <h4 style={{ color: "yellow" }}>*Automatic*</h4>
                <h3>Assign Position</h3>
              </th>
              <th className="text-center">
                {" "}
                <h4 style={{ color: "yellow" }}>*Manual*</h4>
                <h3>Assign Position</h3>
              </th>
            ...
            {usersData
              ...
              .map((row: any, index: any) => (
                <tr key={index}>
                  ...
                  <td>
                    {" "}
                    <Link to={`/view-student-result/${row?._id}`}>
