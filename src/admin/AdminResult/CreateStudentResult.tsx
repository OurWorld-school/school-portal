...
const CreateStudentResult = () => {
  ...
  ////fetch directors result remarks
  React.useEffect(() => {
    const fetchPosts = async () => {
  ...
  React.useEffect(() => {
    ...
    setTotalAverage(parseFloat(totalAverage.toFixed(2))); // Set the total average
  }, [calculateGrandTotal, setTotalScore, setTotalAverage]);
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <p className="mt-4 mb-2">
                          You can alternatively input the HR Remark
                        </p>
                        <TextField
                          variant="outlined"
                          margin="normal"
