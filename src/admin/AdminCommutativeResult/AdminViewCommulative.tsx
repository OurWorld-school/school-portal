...
import {
  ClassApi,
  CommulativeApi,
  CommulativeDeactivateEditApi,
  CommulativePositionApi,
  ResultApi,
  SubjectMarksApi,
  SubjectsApi,
  UserApi,
...
const AdminViewCommulative = () => {
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(CommulativePositionApi + userId, data, headers)
  ...
  const lockResultHandler = (e: any) => {
    ...
    axios
      .put(CommulativeDeactivateEditApi, data, headers)
  ...
  const handleOverallPosition = (e: any) => {
    ...
    axios
      .post(CommulativePositionApi, data, headers)
          ...
          >
            <tr>
              ...
              <th className="text-center">
                <h4 style={{ color: "yellow" }}>*Optional*</h4>
            ...
            {usersData
              ...
              .map((row: any, index: any) => (
                <tr key={index}>
                  ...
                  <td>
                    <form onSubmit={handleOverallPosition}>
                      <Button
                        className="btn-sm"
                        type="submit"
                        // onClick={() => handleShow(row?._id)}
                      >
                        <FaEdit /> Generate Position
                      </Button>
                    </form>
                  </td>
                  ...
                  <td>
                    {" "}
                    <Link to={`/view-student-commulative/${row?._id}`}>
                  ...
                  >
                    {row?.deActivateResultEdith === true ? (
                      ...
                      <>
                        {" "}
                        <Link to={`/update-student-result/${row?._id}`}>
                          <Button className="btn-sm">
                            <FaEdit />{" "}
                          </Button>
                        </Link>{" "}
...
export default AdminViewCommulative;
