...
export default function AdminDirectorsRemark() {
  ...
  const submitHandler = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post(DirectorsRemarkApi, data, { headers });
      setLoading(false);

      if (res.data) {
        toast.success("Director's Remark created successfully!");
        setGradeName("");
        setGradeRange("");
        setGradeRemark("");
      ...
      setLoading(false);
      toast.error(
        "Error: Can't create director's remark. Check inputs or network."
      );
    }
  };
      ...
      <Container component="main" maxWidth="sm">
        ...
        <div className={classes.paper}>
          <Typography component="h1" variant="h5">
            Create Director’s Result Grade & Remark
          </Typography>
