...
const CheckBasic5Result: React.FC<Props> = () => {
  ...
  const fetchApiData = () => {
    ...
    fetch(
      `https://ourworldintschool.onrender.com/api/basic5result/results/${userId}/${selectedYear}/${selectedTerm}`
    )
      ...
      .then((data) => {
        ...
        setLoading(false);
        navigate(
          `/my-results-basic5/${selectedYear}/${userId}/${selectedTerm}`
        );
        console.log(data);
...
export default CheckBasic5Result;
