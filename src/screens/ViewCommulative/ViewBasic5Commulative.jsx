...
export const ViewBasic5Commulative = React.forwardRef((props, ref) => {
      ...
      <div className="mt-2 mb-2">
        <Container>
          <div className="result-main-div-section" ref={componentRef}>
            <div className="result-content-print">
                ...
                <div>
                  ...
                  <div className="sheet-div">
                    <div style={{ textTransform: "uppercase" }}>
                      BASIC 5 SCHOOL TERMINAL CUMULATIVE RESULT SHEET
                    </div>
                  </div>
