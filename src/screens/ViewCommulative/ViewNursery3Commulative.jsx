...
export const ViewNursery3Commulative = React.forwardRef((props, ref) => {
              ...
              <div>
                ...
                <div className="sheet-div">
                  <div style={{ textTransform: "uppercase" }}>
                    Nursery 3 SCHOOL TERMINAL CUMULATIVE RESULT SHEET
                  </div>
                </div>
