...
const UpdateNursery1ResultField = () => {
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(
        `https://ourworldintschool.onrender.com/api/nursery1result/update/otherFields/${id}`,
        // UpdateNursery1resultApi + id,
        data,
        headers
      )
...
export default UpdateNursery1ResultField;
