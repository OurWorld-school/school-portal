...
import {
  ...
  UpdateBasic2resultApi,
  UpdateBasic3resultApi,
  UpdateBasic4resultApi,
  UpdateBasic5resultApi,
  UpdateBasic6resultApi,
  UserApi,
} from "../../../../data/Api";
...
const UpdateBasic6ResultField = () => {
  ...
  React.useEffect(() => {
    const fetchPosts = async () => {
      const { data } = await axios.get(Basic6resultApi + id);
      console.log(data);
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(
        `https://ourworldintschool.onrender.com/api/basic6result/update/otherFields/${id}`,
        // UpdateBasic6resultApi + id,
        data,
        headers
      )
...
export default UpdateBasic6ResultField;
