...
const UpdateBasic3ResultField = () => {
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(
        `https://ourworldintschool.onrender.com/api/basic3result/update/otherFields/${id}`,
        // UpdateBasic3resultApi + id,
        data,
        headers
      )
...
export default UpdateBasic3ResultField;
