...
const UpdateNursery3ResultField = () => {
  ...
  React.useEffect(() => {
    const fetchPosts = async () => {
      const { data } = await axios.get(Nursery3resultApi + id);
      console.log(data);
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(
        `https://ourworldintschool.onrender.com/api/nursery3result/update/otherFields/${id}`,
        // UpdateNursery3resultApi + id,
        data,
        headers
      )
            ...
            <div className="col-lg-8 col-xl-6">
              <div className="card rounded-3">
                <div className="card-body p-4 p-md-5">
                  ...
                  >
                    Update/Edit Nursery 3 Result of
                  </h3>
                  <div
...
export default UpdateNursery3ResultField;
