...
const UpdateBasic4ResultField = () => {
  ...
  React.useEffect(() => {
    const fetchPosts = async () => {
      const { data } = await axios.get(Basic4resultApi + id);
      console.log(data);
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(
        `https://ourworldintschool.onrender.com/api/basic4result/update/otherFields/${id}`,
        // UpdateBasic4resultApi + id,
        data,
        headers
      )
...
export default UpdateBasic4ResultField;
