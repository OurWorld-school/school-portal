...
const UpdateBasic2Result = () => {
  ...
  React.useEffect(() => {
    const fetchPosts = async () => {
      const { data } = await axios.get(Basic2resultApi + id);
      console.log(data);
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .post(UpdateBasic2resultApi + id, data, headers)
...
export default UpdateBasic2Result;
