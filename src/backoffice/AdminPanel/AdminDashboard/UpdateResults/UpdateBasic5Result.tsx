...
const UpdateBasic5Result = () => {
  ...
  useEffect(() => {
    // Fetch result by ID when component mounts
    axios
      .get(Basic5resultApi + id)
      .then((response) => {
  ...
  React.useEffect(() => {
    const fetchPosts = async () => {
      const { data } = await axios.get(Basic5resultApi + id);
      console.log(data);
...
export default UpdateBasic5Result;
