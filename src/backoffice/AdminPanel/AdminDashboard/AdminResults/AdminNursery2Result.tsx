...
import { Nursery2resultApi } from "../../../../data/Api";
...
export default function AdminNursery2Result() {
          ...
          <tbody>
            {filteredData?.map((row: any, index) => (
              <tr key={index}>
                ...
                <td>
                  {" "}
                  <Link to={`/view-nursery2-student-result/${row?._id}`}>
                ...
                <td>
                  {" "}
                  <Link to={`/view-nursery2-student-result-update/${row?._id}`}>
                    <Button className="btn-sm">
                      <FaEdit />
                    </Button>
                  </Link>{" "}
              ...
              {filteredData2?.map((row: any, index) => (
                <tr key={index}>
                  ...
                  <td>
                    {" "}
                    <Link
                      to={`/view-nursery2-student-result-update/${row?._id}`}
                    >
                      <Button className="btn-sm">
                        <FaEdit />
                      </Button>
