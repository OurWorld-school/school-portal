...
export default function AdminBasic1Result() {
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(
        UpdatePosiionBasic1resultApi + viewResult.map((item: any) => item._id),
        data,
        headers
      )
          ...
          <tbody>
            {filteredData?.map((row: any, index) => (
              <tr key={index}>
                ...
                <td>
                  {" "}
                  <Link to={`/view-basic1-student-result/${row?._id}`}>
                ...
                <td>
                  {" "}
                  <Link to={`/view-basic1-student-result-update/${row?._id}`}>
                    <Button className="btn-sm">
                      <FaEdit />
                    </Button>
                  </Link>{" "}
