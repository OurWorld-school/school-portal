...
const AdminPreNurseryResult: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    try {
      const fetchData = async () => {
        ...
        const response = await fetch(PreNurseryresultApi);
  ...
  const [classes, setClasses] = React.useState("Pre-Nursery");
  const handleShowUp = () => {
    setShowUp(true);
  };
  ...
  const lockResultHandler = (e: any) => {
    ...
    axios
      .put(DeActivatePreNurseryresultApi, data, headers)
              ...
              {apiData?.map((item: any, index: any) => (
                <>
                  <tr>
                    ...
                    <td>
                      {" "}
                      <Link to={`/view-prenursery-student-result/${item?._id}`}>
                        <Button className="btn-sm">
                          <BsFillBookmarkCheckFill />{" "}
                        </Button>
                      </Link>{" "}
                    ...
                    >
                      {item?.deActivateResultEdith === true ? (
                        ...
                        <>
                          <Link
                            to={`/view-prenursery-student-result-update/${item?._id}`}
                          >
                            <Button className="btn-sm">
                              <FaEdit />
                            </Button>
                    ...
                    >
                      {item?.deActivateResultEdith === true ? (
                        ...
                        <>
                          <Link
                            to={`/view-prenursery-student-result-update-field/${item?._id}`}
                          >
                            <Button className="btn-sm">
                              <FaEdit />
                            </Button>
