...
// const AdminPreNurseryResult: React.FC = () => {
...
//     fetch(
//       `https://ourworldintschool.onrender.com/api/prenurseryresult/${selectedYear}/${selectedTerm}/`
//     )
...
//     axios
//       .put(UpdatePosiionPreNurseryresultApi + userId, data, headers)
...
//                 <td>
//                   {" "}
//                   <Link to={`/view-prenursery-student-result/${apiData?._id}`}>
...
//                   {" "}
//                   <Link
//                     to={`/view-prenursery-student-result-update/${apiData?._id}`}
//                   >
//                     <Button className="btn-sm">
//                       <FaEdit />
//                     </Button>
...
// export default AdminPreNurseryResult;
// import * as React from "react";
// import { styled } from "@mui/material/styles";
// import Table from "react-bootstrap/Table";
// import TableBody from "@mui/material/TableBody";
...
const AdminNursery3Result: React.FC = () => {
  const [selectedYear, setSelectedYear] = React.useState("");
  const [selectedTerm, setSelectedTerm] = React.useState("");
  ...
  React.useEffect(() => {
    ...
    try {
      const fetchData = async () => {
        ...
        const response = await fetch(Nursery3resultApi);
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(UpdatePosiionNursery3resultApi + userId, data, headers)
  ...
  const [classes, setClasses] = React.useState("Nursery-3");
  const handleShowUp = () => {
    setShowUp(true);
  };
  ...
  const lockResultHandler = (e: any) => {
    ...
    axios
      .put(DeActivateNursery3resultApi, data, headers)
              ...
              {apiData?.map((item: any, index: any) => (
                <>
                  <tr>
                    ...
                    <td>
                      {" "}
                      <Link to={`/view-nursery3-student-result/${item?._id}`}>
                        <Button className="btn-sm">
                          <BsFillBookmarkCheckFill />{" "}
                        </Button>
                      </Link>{" "}
                    ...
                    >
                      {item?.deActivateResultEdith === true ? (
                        ...
                        <>
                          <Link
                            to={`/view-nursery3-student-result-update/${item?._id}`}
                          >
                            <Button className="btn-sm">
                              <FaEdit />
                            </Button>
                    ...
                    >
                      {item?.deActivateResultEdith === true ? (
                        ...
                        <>
                          <Link
                            to={`/view-nursery3-student-result-update-field/${item?._id}`}
                          >
                            <Button className="btn-sm">
                              <FaEdit />
                            </Button>
...
export default AdminNursery3Result;
