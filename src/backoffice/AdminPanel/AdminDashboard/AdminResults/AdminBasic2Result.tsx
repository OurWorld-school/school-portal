...
const AdminBasic2Result: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    try {
      const fetchData = async () => {
        ...
        const response = await fetch(Basic2resultApi);
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(UpdatePosiionBasic2resultApi + userId, data, headers)
  ...
  const [classes, setClasses] = React.useState("Basic-2");
  const handleShowUp = () => {
    setShowUp(true);
  };
  ...
  const lockResultHandler = (e: any) => {
    ...
    axios
      .put(DeActivateBasic2resultApi, data, headers)
              ...
              {apiData?.map((item: any, index: any) => (
                <>
                  <tr>
                    ...
                    <td>
                      {" "}
                      <Link to={`/view-basic2-student-result/${item?._id}`}>
                    ...
                    >
                      {item?.deActivateResultEdith === true ? (
                        ...
                        <>
                          <Link
                            to={`/view-basic2-student-result-update/${item?._id}`}
                          >
                            <Button className="btn-sm">
                              <FaEdit />
                            </Button>
                    ...
                    >
                      {item?.deActivateResultEdith === true ? (
                        ...
                        <>
                          <Link
                            to={`/view-basic2-student-result-update-field/${item?._id}`}
                          >
                            <Button className="btn-sm">
                              <FaEdit />
                            </Button>
...
export default AdminBasic2Result;
