...
import {
  ...
  DeActivateNursery3CommulativeApi,
  ...
  UpdatePosiionNursery3CommulativeApi,
} from "../../../../data/Api";
...
const Nursery3ViewCommulative: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    try {
      const fetchData = async () => {
        ...
        const response = await fetch(Nursery3CommulativeApi);
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(UpdatePosiionNursery3CommulativeApi + userId, data, headers)
  ...
  const lockResultHandler = (e: any) => {
    ...
    axios
      .put(DeActivateNursery3CommulativeApi, data, headers)
                ...
                <>
                  <tr>
                    ...
                    <td>
                      {" "}
                      <Link
                        to={`/view-nursery3-student-commulative/${item?._id}`}
                      >
...
export default Nursery3ViewCommulative;
