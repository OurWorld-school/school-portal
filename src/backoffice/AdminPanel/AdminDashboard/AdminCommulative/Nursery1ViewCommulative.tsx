...
import {
  ...
  DeActivateNursery1CommulativeApi,
  ...
  UpdatePosiionNursery1CommulativeApi,
} from "../../../../data/Api";
...
const Nursery1ViewCommulative: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    try {
      const fetchData = async () => {
        ...
        const response = await fetch(Nursery1CommulativeApi);
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(UpdatePosiionNursery1CommulativeApi + userId, data, headers)
  ...
  const lockResultHandler = (e: any) => {
    ...
    axios
      .put(DeActivateNursery1CommulativeApi, data, headers)
                ...
                <>
                  <tr>
                    ...
                    <td>
                      {" "}
                      <Link
                        to={`/view-nursery1-student-commulative/${item?._id}`}
                      >
...
export default Nursery1ViewCommulative;
