...
const Basic4ViewCommulative: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    try {
      const fetchData = async () => {
        ...
        const response = await fetch(Basic4CommulativeApi);
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .put(UpdatePosiionBasic4CommulativeApi + userId, data, headers)
  ...
  const lockResultHandler = (e: any) => {
    ...
    axios
      .put(DeActivateBasic4CommulativeApi, data, headers)
                ...
                <>
                  <tr>
                    ...
                    <td>
                      {" "}
                      <Link
                        to={`/view-basic4-student-commulative/${item?._id}`}
                      >
...
export default Basic4ViewCommulative;
