...
import { Basic5resultApi, Basic6resultApi, UserApi } from "../../../data/Api";
...
const InputBasic6Result = () => {
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .post(Basic6resultApi, data, headers)
...
export default InputBasic6Result;
