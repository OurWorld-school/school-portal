...
const InputBasic4Commulative = () => {
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .post(Basic4CommulativeApi, data, headers)
  ...
  useEffect(() => {
    try {
      axios.get(Basic4resultApi).then((response) => {
...
export default InputBasic4Commulative;
