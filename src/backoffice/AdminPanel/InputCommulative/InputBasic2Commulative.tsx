...
const InputBasic2Commulative = () => {
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .post(Basic2CommulativeApi, data, headers)
      ...
      .then((res) => {
        ...
        if (res.data) {
          ...
          navigate("/basic2CommulativeResult");
        } else {
  ...
  useEffect(() => {
    try {
      axios.get(Basic2resultApi).then((response) => {
...
export default InputBasic2Commulative;
