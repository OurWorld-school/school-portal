...
const InputBasic5Commulative = () => {
  ...
  const submitHandler = (e: any) => {
    ...
    axios
      .post(Basic5CommulativeApi, data, headers)
      ...
      .then((res) => {
        ...
        if (res.data) {
          ...
          navigate("/basic5CommulativeResult");
        } else {
  ...
  useEffect(() => {
    try {
      axios.get(Basic5resultApi).then((response) => {
...
export default InputBasic5Commulative;
