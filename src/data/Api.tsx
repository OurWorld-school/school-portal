...
export const Nursery2resultApi = "http://localhost:5000/api/nursery2result/";
export const Nursery3resultApi = "http://localhost:5000/api/nursery3result/";
export const Basic1resultApi = "http://localhost:5000/api/basic1result/";
export const Basic2resultApi = "http://localhost:5000/api/basic2result/";
export const Basic3resultApi = "http://localhost:5000/api/basic3result/";
